...
import com.ea2sa.store.domain.ProductCategory;
import com.ea2sa.store.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link com.ea2sa.store.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
